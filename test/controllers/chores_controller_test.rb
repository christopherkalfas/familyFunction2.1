...
class ChoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chore" do
    assert_difference('Chore.count') do
      post chores_url, params: { chore: { house_id: @chore.house_id, name: @chore.name, status: @chore.status } }, as: :json
    end
  ...
  test "should update chore" do
    patch chore_url(@chore), params: { chore: { house_id: @chore.house_id, name: @chore.name, status: @chore.status } }, as: :json
    assert_response 200
  end
